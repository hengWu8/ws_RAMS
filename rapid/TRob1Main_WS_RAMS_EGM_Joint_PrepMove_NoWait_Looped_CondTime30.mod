MODULE TRob1Main
! WS_RAMS long-running EGM diagnostic / CondTime30 diagnostic variant.
!
! Goal:
...
! - Adds WHILE TRUE around the async EGM cycle so the RAPID task stays resident
    ...
    PROC main()
        ...
        TPWrite "WS_RAMS async looped EGM mode CondTime30";
        ...
        WHILE TRUE DO
            ...
            EGMRunJoint egm_id, EGM_STOP_HOLD \NoWaitCond, \J1 \J2 \J3 \J4 \J5 \J6 \CondTime:=30 \RampOutTime:=5;
            EGMWaitCond egm_id;
